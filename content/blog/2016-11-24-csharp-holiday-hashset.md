...
description: "Migrated from Jekyll: C# code for managing holidays using a hashset."
date: 2016-11-24
tags: blog, jekyll, post, csharp, holidays
---

Recently I had to figure out a way to disable an automated process that would 
run on a daily basis. Since the functionality of the Windows Task Scheduler 
...
1. AdjustForWeekendHoliday() - Will push the observed holiday date to Monday if
   the holiday's actual date is on a Sunday, and will move the observed holiday
...
I'll most likely use this in future projects that are required to not run on
